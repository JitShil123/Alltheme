...
if(isset($_POST['submit'])){
	...
	$name= $_POST['name'];
	wp_redirect(get_page_link('http://localhost/wordpress/something/'));
...
//----------------custom widget-------------------
require get_template_directory() . '/widget/about-me.php';
require get_template_directory() . '/widget/widget-spceial.php';

//---------------------setting api----------------------
require get_template_directory() . '/api/setting-api.php';
//--------------------custom api-------------------------
require get_template_directory() . '/api/customize-api.php';
